...
mixin _$PackSlot {
 ...
 String get id; String get packId; int get slotNumber; String? get presetId; String? get sampleId; String? get patternId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,packId,slotNumber,presetId,sampleId,patternId);

@override
String toString() {
  return 'PackSlot(id: $id, packId: $packId, slotNumber: $slotNumber, presetId: $presetId, sampleId: $sampleId, patternId: $patternId)';
}
...
@useResult
$Res call({
 String id, String packId, int slotNumber, String? presetId, String? sampleId, String? patternId
});
...
/// Create a copy of PackSlot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? packId = null,Object? slotNumber = null,Object? presetId = freezed,Object? sampleId = freezed,Object? patternId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String packId,  int slotNumber,  String? presetId,  String? sampleId,  String? patternId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PackSlot() when $default != null:
return $default(_that.id,_that.packId,_that.slotNumber,_that.presetId,_that.sampleId,_that.patternId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String packId,  int slotNumber,  String? presetId,  String? sampleId,  String? patternId)  $default,) {final _that = this;
switch (_that) {
case _PackSlot():
return $default(_that.id,_that.packId,_that.slotNumber,_that.presetId,_that.sampleId,_that.patternId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String packId,  int slotNumber,  String? presetId,  String? sampleId,  String? patternId)?  $default,) {final _that = this;
switch (_that) {
case _PackSlot() when $default != null:
return $default(_that.id,_that.packId,_that.slotNumber,_that.presetId,_that.sampleId,_that.patternId);case _:
  return null;
...
class _PackSlot implements PackSlot {
  const _PackSlot({required this.id, required this.packId, required this.slotNumber, this.presetId, this.sampleId, this.patternId});
...
/// Create a copy of PackSlot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? packId = null,Object? slotNumber = null,Object? presetId = freezed,Object? sampleId = freezed,Object? patternId = freezed,}) {
