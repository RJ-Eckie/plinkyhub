...
@override@JsonKey() List<SavedWavetable> get userWavetables {
 ...
 final  List<SavedWavetable> _starredWavetables;
@override@JsonKey() List<SavedWavetable> get starredWavetables {
  if (_starredWavetables is EqualUnmodifiableListView) return _starredWavetables;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_starredWavetables);
}
