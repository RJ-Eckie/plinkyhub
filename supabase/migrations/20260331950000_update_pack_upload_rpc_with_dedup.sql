-- Updated RPC that supports reusing existing public entries via existing_id
-- and stores content_hash for future deduplication lookups.
...
BEGIN
  ...
  LOOP
    -- If an existing_id is provided, reuse that entry instead of inserting.
  ...
  LOOP
    ...
    ELSE
      INSERT INTO presets (
        user_id, name, category, preset_data, description, is_public, content_hash
      ) VALUES (
